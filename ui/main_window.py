...
class MainWindow(AfterManagerMixin, ctk.CTk):
    ...
    def _configurar_janela(self):
        ...
        largura_janela, altura_janela = 900, 850
    ...
    def _inicializar_gerenciadores(self):
        ...
        try:
            ...
            registrar_log(
                ...
                "Todos os gerenciadores de módulo inicializados com sucesso.",
    ...
    def _on_close(self):
        ...
        if messagebox.askokcancel(
            ...
            "Sair", "Tem a certeza que deseja fechar o sistema?", parent=self
