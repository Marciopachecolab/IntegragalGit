...
def gerar_mapeamento_96() -> List[Dict]:
    ...
    try:
        ...
        registrar_log("Mapeamento Placas", "Mapeamento de 96 poços gerado com sucesso.", level='INFO')
    except Exception as e:
        registrar_log("Mapeamento Placas", f"Erro ao gerar mapeamento de 96 poços: {e}", level='ERROR')
        raise
    return mapeamento
...
def gerar_mapeamento_48(parte: int = 1) -> List[Dict]:
    ...
    registrar_log("Mapeamento Placas", f"Mapeamento 1-para-2 de 48 poços (parte {parte}) gerado.", "INFO")
    return mapeamento
...
def gerar_mapeamento_32(parte: int = 1) -> List[Dict]:
    ...
    if parte not in [1, 2, 3]:
        registrar_log("Mapeamento Placas", f"Valor inválido para 'parte' em mapeamento 32 poços: {parte}. Esperado 1, 2 ou 3.", level='ERROR')
    ...
    try:
        ...
        registrar_log("Mapeamento Placas", f"Mapeamento de 32 poços (parte {parte}) gerado com sucesso.", level='INFO')
    except Exception as e:
        registrar_log("Mapeamento Placas", f"Erro ao gerar mapeamento de 32 poços (parte {parte}): {e}", level='ERROR')
        raise
    return mapeamento
...
def gerar_mapeamento_24(parte: int = 1) -> List[Dict]:
    ...
    if parte not in [1, 2, 3, 4]:
        registrar_log("Mapeamento Placas", f"Valor inválido para 'parte' em mapeamento 24 poços: {parte}. Esperado 1, 2, 3 ou 4.", level='ERROR')
    ...
    try:
        ...
        registrar_log("Mapeamento Placas", f"Mapeamento de 24 poços (parte {parte}) gerado com sucesso.", level='INFO')
    except Exception as e:
        registrar_log("Mapeamento Placas", f"Erro ao gerar mapeamento de 24 poços (parte {parte}): {e}", level='ERROR')
        raise
    return mapeamento