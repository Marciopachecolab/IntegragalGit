...
CORRETOR DE CODIFICA√áÉO ‚Äî Converter todos arquivos para UTF-8 puro (sem BOM)
    ...
    try:
        ...
        try:
            ...
            for enc in ['utf-8', 'latin-1', 'cp1252', 'iso-8859-1']:
                ...
                return False, "Não conseguiu decodificar"
...
def correct_all_files():
    ...
    print("üîß CORRETOR DE CODIFICA√áÉO ‚Äî Convertendo para UTF-8 puro")
    ...
    with open("CORRECAO_CODIFICACAO.log", "w", encoding="utf-8") as f:
        ...
        f.write("LOG DE CORRE√áÉO DE CODIFICA√áÉO\n")
