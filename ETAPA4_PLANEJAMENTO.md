# üéØ ETAPA 4 ‚Äî Formulário Multi-Aba
...
1. Criar classe ExamFormDialog (será grande ~400 linhas)
...
5. Testar valida√ßão antes de salvar



**Tempo estimado:** 3 horas (implementa√ßão + debug)
