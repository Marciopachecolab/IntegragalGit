# üéì ETAPA 1 ‚Äî PREPARA√áÉO & DESIGN
...
- ‚úÖ PLANO_FASE5_RESUMO.md (visão geral)

- ‚úÖ PLANO_FASE5_ETAPAS.md (detalhes técnicos)
...
class ExamConfig:
    ...
    kit_codigo: Any              # ‚Üê C√≥digo numérico
...
- **Esse é o LAYOUT exato que seu formulário vai capturar:**
...

{
  ...
  "nome_exame": "VR1e2 Biomanguinhos 7500",           ‚Üê ABA 1: Básico
...
**Arquivo 3: Padrão de UI Existente** (5 min)
...
Uma `@dataclass` com 15 campos fixos. Voc√™ NÉO pode adicionar campos novos (seria quebra de contrato).



**Consequ√™ncia para UI:**

- Seu formulário tem **exatamente 15 abas de entrada** (13-14 reais, 1-2 auto-calculados)

- Não pode criar campos extras

- Valida√ßão deve verificar tipos corretos
...
### 3Ô∏è‚É£ **Valida√ßão de Schema = Tipo-checking**
...
- Se valida√ßão falhar ‚Üí Não salve

- Exiba erro claro no UI

- Permite usuário corrigir



### 4Ô∏è‚É£ **Fluxo Novo Exame (visão técnica)**
...
4. User clica [Salvar]
   ...
   ‚îÇ  ‚îî‚îÄ NÉO: exiba erro, return
...
‚îÇ [Básico] [Alvos] [Faixas] [RP] [Export] [Controles]    ‚îÇ
...
‚úÖ LEITURA (15 min):
  ...
  [‚úì] Ver padrão UI atual (cadastros_diversos.py)
...
‚úÖ ENTENDIMENTO (20 min):
  ...
  [ ] Conceito 3: Valida√ßão de Schema
...
‚úÖ DECIS√ïES T√âCNICAS:
  ...
  [ ] Slug gera√ßão: "Nome Exame" ‚Üí "nome_exame"?
...
‚úÖ CODIFICA√áÉO PREPARAT√ìRIA:
  ...
  [ ] Definir assinaturas de fun√ßão
...
4. **Responda decis√µes técnicas** ‚Äî 15 min
