...
FASE 6 ‚Äî Script de Migra√ßão de Exames para JSON



Objetivo: Migrar exames de CSV para JSON com valida√ßão
...
# Template padrão para novos exames
...
def create_exam_json(csv_row: Dict, metadata_row: Dict = None) -> Dict:
    ...
    # Aplica configura√ßão espec√≠fica se existir
...
def migrate_all_exams():
    ...
    """Executa migra√ßão completa de exames."""

    

    print("=" * 80)

    print("üöÄ FASE 6 ‚Äî MIGRA√áÉO DE EXAMES PARA JSON")
    ...
    for i, exam_row in enumerate(exames, 1):
        ...
        if not valid:
            ...
            print(f"       ‚ùå Valida√ßão falhou: {msg}")
    ...
    with open("FASE6_MIGRATION_LOG.txt", "w", encoding="utf-8") as f:
        ...
        f.write("FASE 6 ‚Äî LOG DE MIGRA√áÉO\n")
