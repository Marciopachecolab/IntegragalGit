# üöÄ FASE 6 ‚Äî MIGRA√áÉO DE DADOS E VALIDA√áÉO
...
‚îî‚îÄ UI Funcional                 ‚îú‚îÄ Migrar dados CSV ‚Üí JSON
   ...
   ‚îî‚îÄ Dialog CRUD               ‚îú‚îÄ Validar Registry
                                ...
                                ‚îî‚îÄ Sistema Pronto para Produ√ßão
...
4. Listar campos mapeáveis

5. Identificar dados faltantes

6. Gerar script de migra√ßão

```



### ETAPA 2: Migra√ßão (1.5 h)
...
4. Exporta√ßão GAL com painel registry
...
FASE6_migrate_exams_to_json.py        # Script migra√ßão

FASE6_validate_registry.py            # Script valida√ßão
...
09:00 ‚Äî 09:30   ETAPA 1: Análise (30 min)
...
09:30 ‚Äî 11:00   ETAPA 2: Migra√ßão (1.5h)
...
11:00 ‚Äî 12:00   ETAPA 3: Valida√ßão (1h)
...
- [ ] Exporta√ßão GAL com painel (1 teste)
...
**Pr√≥ximo passo:** Executar ETAPA 1 (Análise)
...
**Pr√≥ximo:** Análise de dados existentes
