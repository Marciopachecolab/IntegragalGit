...
FASE 6 ‚Äî Script de Valida√ßão da Registry Ap√≥s Migra√ßão
...
def validate_registry():
    ...
    """Executa valida√ßão completa da registry."""

    

    print("=" * 80)

    print("üìã FASE 6 ‚Äî VALIDA√áÉO DA REGISTRY")
    ...
    test_exams = [
        ...
        "vr1e2 biomanguinhos 7500",  # Com espa√ßo, não underscore!

        "zdc biomanguinhos 7500"       # Com espa√ßo, não underscore!
    ...
    for slug in test_exams:
        ...
        try:
            ...
            if cfg:
                ...
                print(f"   ‚ùå {slug}: Não encontrado")
    ...
    print("üìä RESUMO DA VALIDA√áÉO")
    ...
    with open("FASE6_VALIDATION_REPORT.txt", "w", encoding="utf-8") as f:
        ...
        f.write("FASE 6 ‚Äî RELAT√ìRIO DE VALIDA√áÉO\n")
