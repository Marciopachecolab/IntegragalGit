...
# --- CORREÇÃO: Adiciona 'List' e 'Optional' à importação do typing ---
from typing import List, Optional

# --- Bloco de Configuração Inicial para Imports ---
import os
import sys
...
# ==============================================================================
# CLASSE ORIGINAL: TabelaComSelecaoSimulada (Completa)
# ==============================================================================
...
class TabelaComSelecaoSimulada(AfterManagerMixin, ctk.CTkToplevel):
    ...
    def __init__(self, root, dataframe, status_corrida, num_placa, data_placa_formatada, agravos, usuario_logado: str = "Desconhecido"):
        ...
        if 'Selecionado' not in self.df.columns:
            self.df.insert(0, 'Selecionado', True) # Assume que todos começam selecionados
    ...
    def _popular_tabela(self):
        ...
        for index, row in self.df.iterrows():
            # Converte valores booleanos para um símbolo visual
            row_values = list(row)
    ...
    def _on_double_click(self, event):
        ...
        index = int(item_id)
        # Bloqueia a alteração de seleção em amostras de controlo
    ...
    def _mostrar_relatorio(self):
        ...
        for agravo in self.agravos:
            ...
            if col_resultado in df_selecionados.columns:
                detectaveis = (df_selecionados[col_resultado] == 'Detectável').sum()
                nao_detectaveis = (df_selecionados[col_resultado] == 'Não Detectável').sum()
    ...
    def _gerar_grafico_detectaveis(self):
        ...
        for agravo in self.agravos:
            ...
            if col_resultado in self.df.columns:
                contagem[agravo] = (self.df[col_resultado] == 'Detectável').sum()
...
# ==============================================================================
# NOVA CLASSE DE DIÁLOGO DE SELEÇÃO
# ==============================================================================
class CTkSelectionDialog(ctk.CTkToplevel):
    ...
    def _create_widgets(self, text: str):
        ...
        if self._values: self.combobox.set(self._values[0])
