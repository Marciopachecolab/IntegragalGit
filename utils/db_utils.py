...
def get_postgres_connection():
    ...
    try:
        ...
        registrar_log("DB Utils", f"Erro inesperado ao conectar ao PostgreSQL: {e}", "CRITICAL")
        return None

def salvar_historico_processamento(analista: str, exame: str, status: str, detalhes: str):
    """
    ...
    if conn is None:
        ...
        registrar_log("DB Utils", "Salvamento de histórico ignorado (conexão com DB indisponível ou desabilitada).", "INFO")
        return
    ...
    try:
        ...
        registrar_log("DB Utils", f"Falha ao salvar histórico no PostgreSQL: {e}", "ERROR")
